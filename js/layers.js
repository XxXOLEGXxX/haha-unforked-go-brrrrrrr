addLayer("s", {
    ...
    buyables: {
        ...
        display() { // Everything else displayed in the buyable button after the title
                    let ret = {};
            if (hasUpgrade("s", 34)) return "Knowing that you're being forced to grind the plots, you're getting more bored and it somehow magically boosts your plot gain by " + buyableEffect([this.layer], [this.id]) + "x and shenanigans gain by " + buyableEffect([this.layer], [this.id]).sub(1).div(10).add(1) + "x.";
